...
var EARTH_POLAR_RADIUS = 6356752.3142;
...
function longitude(intValue) {
  // return intValue / EARTH_POLAR_RADIUS * RAD_CONVERSION;
  //[ Caution! ] If the expected longitude (in decimal degrees) is *negative*, use the following line instead:
  return (intValue - MAX_UINT4) / EARTH_POLAR_RADIUS * RAD_CONVERSION
}

/* Converts the passed latitude in lawrence format into the normal latitude value */
function latitude(intValue) {
  var temp = intValue / EARTH_POLAR_RADIUS;
  temp = Math.exp(temp);
